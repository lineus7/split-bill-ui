    ...
    <div className="min-h-dvh flex flex-col bg-highlight-300">
      <header className="sticky top-0 z-10 h-14 bg-light-400 border-b flex items-center justify-center">
        <div className="absolute left-4">
          <Link href="/profile" className="text-sm text-dark-400">Back</Link>
        </div>
        <h1 className="text-[14px] font-bold">Change Password</h1>
      </header>

      <main className="flex-1 p-4">
        <form className="mx-auto w-full max-w-sm space-y-4">
          <div className="space-y-1">
            <label className="block text-sm text-dark-400">Current Password</label>
            <input
              type="password"
          ...
          <div className="space-y-1">
            <label className="block text-sm text-dark-400">New Password</label>
            <input
              type="password"
          ...
          <div className="space-y-1">
            <label className="block text-sm text-dark-400">Confirm New Password</label>
            <input
              type="password"
