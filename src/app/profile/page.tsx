      ...
      <main className="flex-1 p-4 space-y-4">
        ...
        <section className="rounded-2xl border border-light-600 bg-light-300 p-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-highlight-400 text-light-700 flex items-center justify-center font-bold">U</div>
            <div>
        ...
        <section className="space-y-2">
          ...
          <button
            type="button"
            className="w-full rounded-xl border border-error-dark text-error-dark bg-error-light/40 px-4 py-3 text-sm font-medium"
          >
            Logout
          </button>
        </section>
