...
export default function DashboardPage() {
  const bills = [
    { id: "1", name: "Dinner with Team", date: "Sep 15, 2025", total: "Rp 450.000" },
    { id: "2", name: "Weekend Trip", date: "Sep 08, 2025", total: "Rp 1.250.000" },
    { id: "3", name: "Groceries Run", date: "Sep 05, 2025", total: "Rp 320.000" },
  ];
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-highlight-300 pb-24">
      <header className="sticky top-0 z-10 h-14 bg-light-400 border-b flex items-center justify-center">
        <h1 className="text-[14px] font-bold">My Bills</h1>
      </header>
              ...
              <article className="rounded-2xl border border-light-600 bg-light-300 p-4 hover:bg-light-400 transition-colors">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-dark-400 mt-0.5">{b.date}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-semibold text-dark-700">{b.total}</p>
                  </div>
                </div>
              </article>
            </Link>
