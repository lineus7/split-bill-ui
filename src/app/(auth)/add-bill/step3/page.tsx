            ...
            <main className="flex-1 p-4 space-y-4">
                ...
                <section className="space-y-3">
                    {[1, 2, 3].map((i) => (
                        <article
                            key={i}
                            className="rounded-2xl border border-light-600 bg-light-300 p-4 space-y-3"
                        >
                            {/* Name + Price */}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    {[1, 2].map((sidx) => (
                                        <div
                                            key={sidx}
                                            className="grid grid-cols-[1fr,110px] gap-3"
                                        >
                                            <input
                                                type="text"
                            ...
                            <div className="flex justify-end">
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            strokeWidth="2"
                                            d="M3 6h18M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2m-1 0v13a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V6h10Z"
                                        />
                                    </svg>
                                    Delete Item
                                </button>
